...
def cmdline_parse_and_report(num_params, q_device_name_default, q_device_name_help, minimizer_options_default='{}', start_params_zeros_default=True):
    ...
    minimizer_function = getattr(hackathon_optimizers, minimizer_method)   # minimizer_method is a string/name, minimizer_function is an imported callable
...
def get_min_func_src_code():
    ...
    lines = inspect.getsource(hackathon_optimizers.my_minimizer)
    return lines
